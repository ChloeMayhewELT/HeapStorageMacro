...
let package = Package(
    ...
    products: [
        ...
        .library(
            name: "HeapStorageMacro",
            targets: ["HeapStorageMacro"]
        ),
        .executable(
            name: "HeapStorageMacroClient",
            targets: ["HeapStorageMacroClient"]
        ),
    ],
    dependencies: [
